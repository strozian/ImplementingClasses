...
########################################################################
    ...
    def move_to(self, x, y):
        ...
        p1 = Point(self.x_track, self.y_track)
        self.tracking = self.tracking + self.get_distance_from(p1)
        self.x_track = self.x
        self.y_track = self.y
    ...
    def get_distance_from(self, point):
            ...
            return (abs(self.x - point.x)**2 + abs(self.y - point.y)**2)**(1/2)

    def get_distance_from_start(self):
        return self.get_distance_from(Point(self.ox, self.oy))
...
def test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # done: 4.  Follow the same instructions as in  n 3 above,
...
def test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    #  : 6.  Follow the same instructions as in   3 above,
...
def test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    #  : 8.  Follow the same instructions as in   3 above,
...
def test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    #  : 9.  Follow the same instructions as in TODO 3 above,
